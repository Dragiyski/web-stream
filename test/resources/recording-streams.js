import { ReadableStream, WritableStream, TransformStream } from '../../index.js';

export const recordingReadableStream = (extras = {}, strategy) => {
...
export const recordingWritableStream = (extras = {}, strategy) => {
    let controllerToCopyOver;
...
export const recordingTransformStream = (extras = {}, writableStrategy, readableStrategy) => {
    let controllerToCopyOver;
